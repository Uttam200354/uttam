...
const ShivajiDashboard = () => {
  ...
  const renderContent = () => {
    ...
    if (activeSection === 'servers') {
      return (
        <div className="space-y-6">
          ...
          {/* Display both server tables - NO DELETE for Shivaji */}
          <div className="space-y-6">
            <DataTable
              data={data.sap_servers || []}
              columns={columnConfigs.sap_servers}
              onEdit={handleEdit}
              onDelete={null} // No delete for Shivaji
              canDelete={false}
              title="SAP Servers"
    ...
    // Regular sections - NO DELETE for Shivaji
...
export default ShivajiDashboard